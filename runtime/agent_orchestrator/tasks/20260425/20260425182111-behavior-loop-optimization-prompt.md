...
User Value: 3 product areas have had no sprint in 30+ days: behavior_loop_optimization, growth_analytics, cross_page_consistency. These areas have accumulated unaddressed product debt that affects user experience.
...
focus_keys: behavior_loop_optimization, growth_analytics, cross_page_consistency, product_debt
...
## Previous Context
Latest task #323 status=QUEUED objective=8-hour product sprint: Feature usage funnel and retention drop-off analysis
