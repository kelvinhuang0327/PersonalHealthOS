...
User Value: 4 product areas have had no sprint in 30+ days: behavior_loop_optimization, retention_habit_loop, notifications_lifecycle, reports_product_value. These areas have accumulated unaddressed product debt that affects user experience.
...
focus_keys: behavior_loop_optimization, retention_habit_loop, notifications_lifecycle, reports_product_value, product_debt
...
## Previous Context
Latest task #307 status=COMPLETED objective=8-hour product sprint: Full user journey friction audit — Report upload to Action complete
