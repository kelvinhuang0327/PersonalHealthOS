...
User Value: 1 product areas have had no sprint in 30+ days: behavior_loop_optimization. These areas have accumulated unaddressed product debt that affects user experience.
...
focus_keys: behavior_loop_optimization, product_debt
...
## Previous Context
Latest task #327 status=QUEUED objective=8-hour product sprint: Action → Outcome → Feedback closed-loop optimization
